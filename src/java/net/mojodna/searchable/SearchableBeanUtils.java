...
public class SearchableBeanUtils {
	...
	public static String[] getDefaultFieldNames(
		...
		final Searchable.DefaultFields annotation = (Searchable.DefaultFields) AnnotationUtils
				.getAnnotation(clazz, Searchable.DefaultFields.class);
		if (null != annotation)
	 ...
	 */
	public static String getExcerptPropertyName(
		...
		for (final PropertyDescriptor d : descriptors) {
			if (AnnotationUtils.isAnnotationPresent(d.getReadMethod(),
					Searchable.Excerptable.class))
				return d.getName();
		}
